---
title: "Bechdel analysis - solutions"
author: ""
output: 
  github_document: 
    fig_height: 5
...
1. There are `r nrow(bechdel90_13)` movies between 1990 and 2013. Hint: each row in the `bechdel90_13` table we just made represents a different movie. Type `bechdel90_13` into the console to see the table dimensions.
